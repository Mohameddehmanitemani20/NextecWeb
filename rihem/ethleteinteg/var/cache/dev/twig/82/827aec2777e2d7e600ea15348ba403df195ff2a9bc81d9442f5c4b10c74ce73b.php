...
class __TwigTemplate_f7744cd1dbb416942184a593efc9966c911bf4bd828a9f0d5aaa279f6b768ac4 extends Template
{
    private $source;
    private $macros = [];
...
{% block captcha_widget %}
    {% apply spaceless %}
        ...
        {{ form_widget(form, { 'id': user_input_id, 'value': '' }) }}
    {% endapply  %}
{% endblock %}", "@Captcha/captcha.html.twig", "C:\\Users\\ASUS\\Desktop\\web\\ethleteinteg\\templates\\bundles\\CaptchaBundle\\captcha.html.twig");
    }
}
