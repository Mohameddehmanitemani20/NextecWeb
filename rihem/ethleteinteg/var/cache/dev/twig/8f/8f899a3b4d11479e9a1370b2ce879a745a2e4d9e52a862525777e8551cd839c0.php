...
class __TwigTemplate_d4df7000ee711eac543fb52aadf3d9a2d5dd03ab0d3af993b9d0a8248cb50166 extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    {{ form_widget(form) }}
   <button class=\"button-34\">{{ button_label|default('Enregistrer') }}</button>
{{ form_end(form) }}
", "reclamation/_form.html.twig", "C:\\Users\\ASUS\\Desktop\\web\\ethleteinteg\\templates\\reclamation\\_form.html.twig");
    }
}
