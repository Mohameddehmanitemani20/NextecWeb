...
public class AddPlat extends BaseForm {
    ...
    public AddPlat(Resources res, Form previous) {
        ...
        note.getStyle().setFgColor(154245);
        ...
        btnValider.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent evt) {
                if ((note.getText().length() == 0) || (idUser.getText().length() == 0)) {
                    Dialog.show("Alert", "Please fill all the fields", new Command("OK"));
                } else {
                    try {

                        Avis avis = new Avis(Integer.parseInt(note.getText()), Integer.parseInt(idUser.getText()));
                        if (Service.getInstance().AddAvis(avis)) {
