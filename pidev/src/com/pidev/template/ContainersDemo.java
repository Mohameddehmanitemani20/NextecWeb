...
public class ContainersDemo extends Demo{
    ...
    public ContainersDemo(Form parentForm) {
        init("Blog", getGlobalResources().getImage("containers-demo.png"), parentForm, "https://github.com/codenameone/KitchenSink/blob/master/src/com/codename1/demos/kitchen/ContainersDemo.java");
    }
